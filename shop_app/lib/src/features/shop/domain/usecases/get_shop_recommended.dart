import 'package:shop_app/src/features/shop/data/repositories/shop_recommended_repository.dart';
...
class GetShopRecommended implements UseCase<Future<List<ShopItemEntity>>> {
  final ShopItemRepository _shopItemRepository = ShopRecommendedRepository();
